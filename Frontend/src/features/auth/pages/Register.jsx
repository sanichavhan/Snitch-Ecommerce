...
const Register = () => {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            setLocalError(error || err.message || 'Registration failed. Please try again.')
        }
    }
        ...
        <div className="min-h-screen bg-[#0e0e0e] text-[#e5e2e1] font-sans selection:bg-[#FFD700] selection:text-[#131313] flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-16 min-h-screen overflow-y-auto z-10 bg-[#0e0e0e]">
                <div className="w-full max-w-md bg-[#131313] lg:bg-transparent p-10 md:p-14 lg:p-6 rounded-2xl lg:rounded-none shadow-[0_24px_48px_-12px_rgba(0,0,0,0.5)] lg:shadow-none">
                    ...
                    {(localError || error) && (
                        <div className="mb-6 p-3 bg-red-900/20 border border-red-600 rounded text-red-400 text-sm">
                            {localError || error}
                        </div>
                    )}
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-8">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="mt-6 w-full bg-gradient-to-r from-[#e9c400] to-[#ffd700] text-[#131313] font-bold tracking-wide py-4 px-8 rounded hover:shadow-[0_0_20px_rgba(255,215,0,0.3)] hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                        ...
                        <button
                            ...
                            className="mt-4 w-full bg-[#4285f4] text-white font-bold tracking-wide py-4 px-8 rounded hover:bg-[#3367d6] hover:shadow-[0_0_20px_rgba(66,133,244,0.3)] hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 flex items-center justify-center gap-2"
                        >
